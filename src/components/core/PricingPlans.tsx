...
const PricingPlans = () => {
  return (
    <div className="px-40 bg-slate-50 flex flex-col items-center justify-center p-10">
      ...
      <div className="grid grid-cols-3 gap-5 w-full my-10">
        {pricingPlans.map((plan, id) => (
          <div
            className="w-full flex flex-col gap-3 items-start justify-stretch bg-white rounded-xl shadow-lg"
            key={id}
          >
            <div className="w-full p-5">
              <div className="w-full p-5 flex flex-col items-center gap-5">
                ...
                <p
                  className="text-slate-600 font-bold text-3xl flex items-end gap-1   
              "
                >
                ...
                <p className="text-slate-500">{plan.bestFor}</p>
                <Button
